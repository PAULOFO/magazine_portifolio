...
import 'package:magazineportifolio/data/general_data.dart';
...
import 'package:magazineportifolio/others/responsive_widget.dart';
...
class TitleMagazine extends StatelessWidget {
  String desc =
      'Apps nativos Android e iOS criados através do framework Flutter da Google';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          gradient: LinearGradient(///colors: [const Color(0xffFEB692), const Color(0xffEA5455)
              colors: [const Color(0xFF213A50), const Color(0xffEA5455)])),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          gradient: LinearGradient(
              colors: [const Color(0xFF213A50), const Color(0xffEA5455)])),
      child: Container(
        width: MediaQuery.of(context).size.width > 600//800
            ? 600//800
            : MediaQuery.of(context).size.width,
        alignment: Alignment.center,
        child: SizedBox(
